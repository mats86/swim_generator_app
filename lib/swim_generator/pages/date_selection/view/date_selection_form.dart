      ...
      builder: (context, state) {
        return TextFormField(
          ...
          decoration: const InputDecoration(
            ...
            //errorText:state.birthDay.isValid ? state.birthDay.error?.message : null,
          ),
        );
      },
    );
...
class _FixDatesRadioButton extends StatelessWidget {
  Widget buildDateText(BuildContext context, DateSelectionState state,
      int index) {
    final fixDateFrom =
